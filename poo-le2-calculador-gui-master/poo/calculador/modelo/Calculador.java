...
public class Calculador
{
    ...
    public int multiplique(int n1, int n2) {
        ...
        for (int i = 1; i <= numeroDeSomas; i++)
            soma = soma + quantidadeASomar;
    ...
    public boolean saoAmigos(int n1, int n2) {
        int somamdcesPropriosN1 = calculeSomaDosDivisores(n1) - n1;
        int somamdcesPropriosN2 = calculeSomaDosDivisores(n2) - n2;

        return somamdcesPropriosN1 == n2 && somamdcesPropriosN2 == n1;
    }
    ...
    public boolean ehPrimo(int n) {
        ...
        if ( n != 2 && n % 2 == 0)
            ...
            int maximoDivisor = n / 2;
            int divisor = 3;
            primo = true; // acredito que é primo
            while (primo && divisor <= maximoDivisor)
                if (n % divisor == 0)
                    primo = false;
                else
                    divisor = divisor + 2;
